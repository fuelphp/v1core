...
class Config_Php extends \Config_File
{
	...
	public function save($contents)
	{
		...
		is_null(static::$uses_opcache) and static::$uses_opcache = (PHP_VERSION_ID >= 50500 and function_exists('opcache_invalidate'));

		// do we have APC active?
		is_null(static::$uses_apc) and static::$uses_apc = function_exists('apc_compile_file');

		// determine if we have an opcode cache active
		is_null(static::$flush_needed) and static::$flush_needed = static::$uses_opcache or static::$uses_apc;
